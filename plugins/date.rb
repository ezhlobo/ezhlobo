module Octopress
  module Date
    ...
    def format_date(date, format, cut = false)
      date = datetime(date)
...
module Jekyll
  ...
  class Post
    ...
    def to_liquid
      ...
      self.data.deep_merge({
        ...
        "date_formatted_cut"=> format_date(self.date, date_format, true),
  ...
  class Page
    ...
    def initialize(site, base, dir, name)
      ...
      self.data['date_formatted_cut']= format_date(self.data['date'], date_format, true) if self.data.has_key?('date')
