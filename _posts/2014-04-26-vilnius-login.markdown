...
<img width="650" height="547" data-echo="{{ page.pics_dir }}{{ page.pic[0] }}" alt="Женя Жлобо и Вадим Грибанов">
...
<figcaption>
	<img width="320" height="213" data-echo="{{ page.pics_dir }}{{ page.pic[1] }}" alt="Тротуар в Вильнюсе" class="_half">
	<img width="320" height="213" data-echo="{{ page.pics_dir }}{{ page.pic[2] }}" alt="Одна из стен в Вильнюсе" class="_half">
</figcaption>
...
<figcaption>
	<img width="320" height="240" data-echo="{{ page.pics_dir }}{{ page.pic[3] }}" alt="" class="_third">
	<img width="320" height="240" data-echo="{{ page.pics_dir }}{{ page.pic[4] }}" alt="" class="_third">
	<img width="650" height="384" data-echo="{{ page.pics_dir }}{{ page.pic[5] }}" alt="" class="_third">
</figcaption>
...
<img width="650" height="488" data-echo="{{ page.pics_dir }}{{ page.pic[6] }}" alt="Стенд dragdis в Вильнюсе на LOGIN 2014">
