...
ssh_user       = "evgen@losky.net"
ssh_port       = "22"
document_root  = "~/evgen.zhlobo.info/www/"
rsync_delete   = false
...
task :preview do
  ...
  system "compass compile --output_style :nested --css-dir #{source_dir}/stylesheets" unless File.exist?("#{source_dir}/stylesheets/screen.css")
  jekyllPid = Process.spawn({"OCTOPRESS_ENV"=>"preview"}, "jekyll --auto")
  compassPid = Process.spawn("compass watch")
